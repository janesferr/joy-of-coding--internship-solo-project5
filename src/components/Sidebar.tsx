    ...
    <Container>
      ...
      >
        ...
        <StyledMenuItem
          translate="no"
          onClick={() => {
            window.open("https://github.com/janesferr");
          }}
        >
          <GitHub /> &nbsp; Github{" "}
          {stars && (
        ...
        <StyledMenuItem
          onClick={() => {
            window.open("https://github.com/janesferr/new-solo/issues");
          }}
        >
        ...
        >
          <BmcIcon className="bmc-icon" src={bmcLogo} /> &nbsp; Donate with me{" "}
        </StyledMenuItem> 
        <Divider sx={{ margin: "0 8px" }} />
        ...
        >
          ...
          <CreditsContainer translate="no">
            ...
            <a
              ...
              href="https://github.com/janesferr"
            >
            Jane 
            </a>
          </CreditsContainer>
